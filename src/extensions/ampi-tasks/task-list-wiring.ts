...
import { registerLowerAboveEditorWidget } from "../ampi-core/above-editor-order.js";
...
export function registerTaskListWiring(pi: ExtensionAPI): void {
  registerAmpiOwnedTool("task_list");
  ...
  // The task-list widget shares Pi's aboveEditor stack with the ampi-workers
  ...
  // `pi.appendEntry("ampi-tasks.todo-state", ...)` on the active Pi
