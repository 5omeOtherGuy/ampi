/**
 * Backend-neutral types for `ampi-web` search providers.
 *
 ...
 * `WebSearchDetails.backend`, `/ampi-status` rows, and provider diagnostics
 ...
 * able to apply it. `ampi-web` never silently drops a filter: every requested
