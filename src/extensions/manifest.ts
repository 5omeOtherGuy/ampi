...
export const MMR_EXTENSION_MANIFEST: readonly MmrExtensionManifestEntry[] = Object.freeze([
  ...
  {
    name: "mmr-async-tasks",
    entrypoint: "./src/extensions/mmr-async-tasks/index.ts",
    exportSubpath: "./extensions/mmr-async-tasks",
    autoLoaded: true,
    tools: ["start_task", "task_poll", "task_wait", "task_cancel"],
    dynamicTools: false,
