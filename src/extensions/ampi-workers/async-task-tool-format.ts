...
export function notFoundResult(
  ...
  return {
    ...
    details: { worker: "ampi-workers.async-task", tool, taskId, errorMessage: message },
  };
}
...
export function validationResult(message: string, tool: string = START_TASK_TOOL_NAME): AgentToolResult<AsyncTaskToolDetails> {
  return {
    ...
    details: { worker: "ampi-workers.async-task", tool, errorMessage: message },
  };
}
...
export function groupNotFoundResult(
  ...
  return {
    content: [{ type: "text", text: message }],
    details: { worker: "ampi-workers.async-task", tool, groupId, errorMessage: message },
  };
}
