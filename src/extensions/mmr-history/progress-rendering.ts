 ...
 * `mmr-history` tools (`find_session` and `read_session`).
 *
 * Mirrors the conventions used by `mmr-subagents`'
 ...
 * `mmr-history`-specific structure on top of the shared formatters.
 */
 ...
 * (mmr-history tools already produce markdown-shaped text) and
