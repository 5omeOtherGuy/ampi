...
#
# Purpose: the post-c286a07 workflow merges PRs server-side via `gh pr merge`
...
# working tree (or runs `pi -e <primary>`) sees stale code. This script is
# the sanctioned way to reconcile.
#
# Behavior:
